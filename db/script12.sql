...
FETCH BACKWARD ALL FROM curs_products;

FETCH ABSOLUTE 15 FROM curs_products;
FETCH ABSOLUTE 7 FROM curs_products;
FETCH ABSOLUTE 2 FROM curs_products;
FETCH FIRST FROM curs_products;
CLOSE curs_products;
COMMIT;
